...
1. When the user signs up, complete the sign-in flow for the user's authentication provider up to, but not including, calling one of the Auth.SignIn methods. 2. Get an AuthCredential for the new authentication provider 3. Pass the AuthCredential object to the sign-in user's Link method: 
...
1. Sign in the user using any authentication provider or method. 2. Complete the sign-in flow for the new authentication provider up to, but not including, calling one of the SignIn methods. 3. Get a AuthCredential for the new authentication provider. 4. Pass the AuthCredential object to the signed-in user's Link method: 
...
[1]: https://firebase.google.com/console/ [2]: http://support.google.com/firebase/answer/7015592 [3]: https://components.xamarin.com/gettingstarted/googleiossignin [4]: https://components.xamarin.com/gettingstarted/facebookios [5]: https://developers.facebook.com/ [6]: https://console.developers.google.com/apis/credentials [7]: https://www.nuget.org/packages/xamarin.auth [8]: https://components.xamarin.com/gettingstarted/xamarin.auth [9]: https://apps.twitter.com/ [10]: https://github.com/settings/applications/new [11]: https://github.com/settings/developers [12]: https://support.google.com/firebase/answer/7000714 [13]: https://bugzilla.xamarin.com/show_bug.cgi?id=43689 
*/